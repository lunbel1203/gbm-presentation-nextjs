                ...
                <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-10 shadow-2xl border border-white/20">
                        ...
                        <p className="text-lg md:text-xl text-white/90 mb-6 leading-relaxed">
                            This presentation is optimized for desktop screens.
                        </p>
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                            <p className="text-base md:text-lg text-white/80 leading-relaxed">
                                Please open it from a <span className="text-gbm-green font-bold">computer</span> to enjoy the best experience with all animations and interactions.
                            </p>
                        </div>
                    </div>
