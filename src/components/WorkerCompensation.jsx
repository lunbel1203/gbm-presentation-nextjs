            ...
            <section id="worker-compensation" className="compensation-section w-full h-screen relative">
                <div className="compensation-overlay w-full flex items-center px-20 bg-white absolute inset-0">
                    ...
                    <div className="compensation-title-container w-[40%] text-left">
                        ...
                        <h3 className="w-full text-4xl font-bold text-gbm-green mb-10">Todos los trabajadores son remunerados con base en un salario digno.</h3>
                        <div className="w-24 h-1 bg-gbm-green mb-10"></div>
                        <h3 className='text-2xl font-bold bg-gradient-to-r from-[#194263] to-gbm-green bg-clip-text text-transparent'>(Esto representa un 20-30% por encima del salario mínimo del estado Dominicano) Tasa de rotación de trabajadores de limpieza: 20% anual (Promedio de la industria = 200%)</h3>
                    </div>
                </div>
